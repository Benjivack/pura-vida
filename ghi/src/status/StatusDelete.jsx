            ...
            <tr>
              <td>
                {status_user_id === `${logger.id}` ? (
                    <button className="m-4 bg-red-500 hover:bg-red-400 text-white font-bold py-1 px-1 rounded focus:outline-none focus:shadow-outline" onClick={() => navigateToProfile(status_id)}>
                        Delete
                    </button>
                ) : null}
              </td>
